...
function Section({ section }) {
  ...
  const articles =
    section.content && section.content["articles"]
              ...
              !utils.isSafari() && (
                ...
                >
                  ...
                  <div className="download-cv">
                    <a
                      href="/assets/wallelign_workie.pdf"
                      download
...
function SectionHeader({ section }) {
  ...
  let title = utils.parseJsonText(
    getTranslation(section.content["locales"], "title_long")
  );
  let prefix = utils.parseJsonText(
    getTranslation(section.content["locales"], "title_long_prefix", true)
  );
  if (!isBreakpoint("lg")) {
  ...
  return (
    ...
    >
      ...
      <h3
        className={`fw-bold ${isBreakpoint("lg") ? "lead-4" : ""} mx-4 mb-0`}
